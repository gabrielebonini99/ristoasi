  ...
  const popupHtml = `
    <div class="popup">
      <div class="popup-content">
        ...
        <p>Non gestiamo le prenotazioni online richieste via mail. Per tentare di prenotare un tavolo siete pregati di contattare telefonicamente e direttamente il locale del gruppo al quale siete interessati.</p>
      </div>
    </div>
  `;
