  ...
  const popupHtml = `
    <div class="popup">
      <div class="popup-content">
        ...
        <p>È arrivato il momento di celebrare la Pasqua: scopri il nostro menu pasquale, ricco di piatti freschi, sapori primaverili e tutto il gusto della tradizione. Prenota il tuo tavolo e festeggia con noi una Pasqua speciale, tra cibo delizioso, atmosfera familiare e tanta gioia! <a href="uploads/antico-casale-menu-pasqua-2026.pdf" target="_blank">Clicca qui</a> per scaricare il menu in formato PDF.</p>
      </div>
    </div>
  `;
